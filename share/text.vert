...
void main(){
	...
	vec2 vertexPosition_homoneneousspace = vertex.xy - vec2(screen.x/2,screen.y/2); // [0..800][0..600] -> [-400..400][-300..300]
	vertexPosition_homoneneousspace /= vec2(screen.x/2,screen.y/2);
